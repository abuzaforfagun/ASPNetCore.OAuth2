...
namespace ASPNetCore.OAuth2.IdentityServerConfiguration
{
    public class Config
    {
            ...
            return new List<ApiResource>
              {
                ...
                new ApiResource("scope.partialaccess", "Example API"),
        ...
        public static IEnumerable<Client> GetClients()
        {
            return new List<Client>
            {
                ...
                new Client
                {
                    ClientId="ClientWithPartialAccess",
                    AllowedGrantTypes = GrantTypes.ClientCredentials,
                    ClientSecrets =
                    {
                        new Secret ("secretval".Sha256())
                    },
                    AllowedScopes={ "scope.partialaccess" }
                }
            };
        }
    }
